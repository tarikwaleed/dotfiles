...
complete -c git-config -l base -d 'option of format-patch by default.  format. notes'
...
complete -c git-config -l keep-base-pack -d 'except that all packs that meet the threshold are kept, not just the base pack'
...
complete -c git-config -l ntlm -d 'curl(1)) http. emptyAuth'
...
complete -c git-config -l decorate -d 'option of the git log.  log. follow'
...
complete -c git-config -l no-use-mailmap -d 'mailinfo. scissors'
...
complete -c git-config -l recurse-submodules -d 'rebase. useBuiltin'
complete -c git-config -l autosquash -d 'option by default.  rebase. autoStash'
complete -c git-config -l no-autostash -d and
complete -c git-config -l autostash -d 'options of git-rebase(1).  Defaults to false.  rebase. missingCommitsCheck'
complete -c git-config -l exec -d 'option was provided).  This is the same as specifying the'
complete -c git-config -l reschedule-failed-exec -d 'option.  receive. advertiseAtomic'
...
complete -c git-config -l relogin-delay -d 'option of git-send-email(1).  sequence. editor'
