...
complete -c tsget -s h -d 'The \\s-1URL\\s0 of the \\s-1HTTP/HTTPS\\s0 server listening for time stamp reque…'
...
complete -c tsget -s d -d 'Switches on verbose mode for the underlying curl library'
...
complete -c tsget -o rand -d 'The files containing random data for seeding the random number generator'
