...
complete -c netcat -s n -d 'Do not do any DNS or service lookups on any specified addresses, hostnames or…'
...
complete -c netcat -s s -d 'Send packets from the interface with the source IP address'
