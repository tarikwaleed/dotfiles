...
complete -c find -o fstype -d 'FOO predicate and specify a filesystem type FOO which is not known (that is, …'
...
complete -c find -s n -d 'for less than n , n for exactly n '
...
complete -c find -o gid -d 'File\'s numeric group ID is n '
complete -c find -o group -d 'File belongs to group gname (numeric group ID allowed)'
complete -c find -o iname -d Like
complete -c find -o inum -d 'File has inode number n .  It is normally easier to use the'
...
complete -c find -o links -d 'File has n hard links'
...
complete -c find -o size -d 'File uses n units of space, rounding up'
...
complete -c find -o uid -d 'File\'s numeric user ID is n '
complete -c find -o used -d 'File was last accessed n days after its status was last changed'
...
complete -c find -o 444 -d or
complete -c find -o a+r -d 'have at least one write bit set ('
