...
complete -c pstree -s n -d 'Sort processes with the same ancestor by PID instead of by name'
...
complete -c pstree -s Z -d '(SELinux) Show security context for each process'
