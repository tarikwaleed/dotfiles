...
complete -c git-format-patch -s W -l function-context -d 'Show whole surrounding functions of changes'
...
complete -c git-format-patch -s s -l signoff -d 'Add Signed-off-by: line to the commit message, using the committer identity o…'
...
complete -c git-format-patch -l patch
