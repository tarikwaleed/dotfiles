...
complete -c git-ls-files -l recurse-submodules -d 'Recursively calls ls-files on each submodule in the repository'
complete -c git-ls-files -l abbrev -d 'Instead of showing the full 40-byte hexadecimal object lines, show only a par…'
