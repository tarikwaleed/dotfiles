...
complete -c dpkg-divert -l remove -d 'Remove a diversion for file.  The file is currently not renamed, see --rename'
complete -c dpkg-divert -l list -d 'List diversions matching glob-pattern'
complete -c dpkg-divert -l listpackage -d 'Print the name of the package that diverts file (since dpkg 1. 15. 0)'
complete -c dpkg-divert -l truename -d 'Print the real name for a diverted file'
complete -c dpkg-divert -l version -d 'Show the version and exit'
complete -c dpkg-divert -o old
