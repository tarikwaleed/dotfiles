...
complete -c journalctl -s q -l quiet -d 'Suppresses all informational messages (i. e.  "-- Logs begin at '
...
complete -c journalctl -l case-sensitive -d 'Make pattern matching case sensitive or case insenstive'
