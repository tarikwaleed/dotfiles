...
complete -c git-checkout -l detach -d 'Rather than checking out a branch to work on it, check out a commit for inspe…'
...
complete -c git-checkout -l recurse-submodules -l no-recurse-submodules -d 'Using --recurse-submodules will update the content of all initialized submodu…'
