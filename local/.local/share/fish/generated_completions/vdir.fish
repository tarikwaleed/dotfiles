...
complete -c vdir -l time -d 'with -l, show time as WORD instead of default modification time: atime or acc…'
complete -c vdir -l time-style -d 'time/date format with -l; see TIME_STYLE below'
complete -c vdir -s t -d 'sort by modification time, newest first'
