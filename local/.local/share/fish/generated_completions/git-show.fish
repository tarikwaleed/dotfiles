...
complete -c git-show -l abbrev-commit -d 'Instead of showing the full 40-byte hexadecimal commit object name, show only…'
...
complete -c git-show -l unfold -d 'option was given'
...
complete -c git-show -s t -d 'option in git-log to also find trees'
...
complete -c git-show -l relative
...
complete -c git-show -s c -d 'option is used): diff --combined file or like this (when the'
complete -c git-show -l cc -d 'option is used): diff --cc file  2. c   2.  4. 2'
