...
complete -c git-diff-files -l relative -d 'When run from a subdirectory of the project, it can be told to exclude change…'
...
complete -c git-diff-files -s W -l function-context -d 'Show whole surrounding functions of changes'
