...
complete -c git-apply -l index -d 'When --check is in effect, or when applying the patch (which is the default w…'
complete -c git-apply -l cached -d 'Apply a patch without touching the working tree'
