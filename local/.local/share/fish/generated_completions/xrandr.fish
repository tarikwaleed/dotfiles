...
complete -c xrandr -l fbmm -d 'Sets the reported values for the physical size of the screen'
complete -c xrandr -l dpi -d 'This also sets the reported physical size values of the screen, it uses the s…'
