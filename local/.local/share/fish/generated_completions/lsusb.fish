...
complete -c lsusb -s s -d 'Show only devices in specified  bus and/or  devnum'
...
complete -c lsusb -s t -d 'Tells  lsusb to dump the physical USB device hierarchy as a tree'
