...
complete -c usb_modeswitch -s 2 -s 3 -l message-content2 -l message-content3 -d 'Additional bulk messages to send as switching commands'
complete -c usb_modeswitch -s w -l release-delay -d 'After issuing all bulk messages, wait for NUM milliseconds before releasing t…'
...
complete -c usb_modeswitch -s s -l check-success -d 'After switching, keep checking for the result up to max.  NUM seconds'
