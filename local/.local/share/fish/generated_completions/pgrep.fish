...
complete -c pgrep -s v -l inverse -d 'Negates the matching.   This option is usually used in  pgrep \'s context'
complete -c pgrep -s w -l lightweight -d 'Shows all thread ids instead of pids in  pgrep \'s context'
complete -c pgrep -s x -l exact -d 'Only match processes whose names (or command line if -f is specified)  exactl…'
complete -c pgrep -s F -l pidfile -d 'Read R PID \'s from file'
