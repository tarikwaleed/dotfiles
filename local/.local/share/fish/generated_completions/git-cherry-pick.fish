...
complete -c git-cherry-pick -s s -l signoff -d 'Add Signed-off-by line at the end of the commit message'
complete -c git-cherry-pick -s S -l gpg-sign -d 'GPG-sign commits'
