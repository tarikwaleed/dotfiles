...
complete -c git-rev-list -l abbrev-commit -d 'Instead of showing the full 40-byte hexadecimal commit object name, show only…'
...
complete -c git-rev-list -l unfold -d 'option was given'
