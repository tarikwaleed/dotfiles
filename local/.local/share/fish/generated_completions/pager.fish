...
complete -c pager -o Dxcolor -l color -d '[MS-DOS only] Sets the color of the text displayed'
...
complete -c pager -o kfilename -l lesskey-file -d 'Causes  less to open and interpret the named file as a  lesskey (1) file'
...
complete -c pager -s R -l RAW-CONTROL-CHARS -d 'Like -r, but only ANSI "color" escape sequences are output in "raw" form'
...
complete -c pager -l MOUSE -d 'Like --mouse, except the direction scrolled  on mouse wheel movement is rever…'
...
complete -c pager -s t -d 'use of tags files   metacharacters in filenames, such as *   filename complet…'
