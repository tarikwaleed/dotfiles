...
complete -c x86_64-linux-gnu-ld -o Bsymbolic -d 'Bind defined symbols locally'
complete -c x86_64-linux-gnu-ld -o Bsymbolic-functions -d 'Bind defined function symbols locally'
...
complete -c x86_64-linux-gnu-ld -l export-dynamic-symbol -d 'Export SYMBOL to dynamic symbol table'
