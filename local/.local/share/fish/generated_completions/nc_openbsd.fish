...
complete -c nc_openbsd -s n -d 'Do not do any DNS or service lookups on any specified addresses, hostnames or…'
...
complete -c nc_openbsd -s s -d 'Send packets from the interface with the source IP address'
