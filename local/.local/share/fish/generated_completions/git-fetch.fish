...
complete -c git-fetch -l auto-gc -d 'Run git gc --auto at the end to perform garbage collection if needed'
...
complete -c git-fetch -l set-upstream -d 'If the remote is fetched successfully, pull and add upstream (tracking) refer…'
