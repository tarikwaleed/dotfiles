...
complete -c mtr -s t -l curses -d 'Use this option to force   mtr  to use the curses based terminal interface (i…'
...
complete -c mtr -s p -l split -d 'Use this option to set  mtr  to spit out a format that is suitable for a spli…'
complete -c mtr -s n -l no-dns -d 'Use this option to force   mtr  to display numeric IP numbers and not try to …'
...
complete -c mtr -s e -l mpls -d 'Use this option to tell   mtr  to display information from ICMP extensions fo…'
