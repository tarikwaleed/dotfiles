...
complete -c man-recode -l suffix -d 'Form each output file name by appending R suffix to the input file name, afte…'
...
complete -c man-recode -s V -l version -d 'Display version information.  SEE ALSO iconv (1), man (1), manconv (1) AUTHOR'
