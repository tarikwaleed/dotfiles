...
complete -c git-commit -s s -l signoff -d 'Add Signed-off-by line by the committer at the end of the commit log message'
...
complete -c git-commit -s S -l gpg-sign -d 'GPG-sign commits'
complete -c git-commit -l no-gpg-sign -d 'Countermand commit'
