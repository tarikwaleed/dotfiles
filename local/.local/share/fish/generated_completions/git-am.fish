...
complete -c git-am -s s -l signoff -d 'Add a Signed-off-by: line to the commit message, using the committer identity…'
...
complete -c git-am -s S -l gpg-sign -d 'GPG-sign commits'
...
complete -c git-am -l show-current-patch -d 'Show the entire e-mail message "git am" has stopped at, because of conflicts'
