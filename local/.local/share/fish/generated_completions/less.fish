...
complete -c less -o kfilename -l lesskey-file -d 'Causes  less to open and interpret the named file as a  lesskey (1) file'
...
complete -c less -l MOUSE -d 'Like --mouse, except the direction scrolled  on mouse wheel movement is rever…'
...
complete -c less -s t -d 'use of tags files   metacharacters in filenames, such as *   filename complet…'
