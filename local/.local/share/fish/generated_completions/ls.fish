...
complete -c ls -l time -d 'with -l, show time as WORD instead of default modification time: atime or acc…'
complete -c ls -l time-style -d 'time/date format with -l; see TIME_STYLE below'
complete -c ls -s t -d 'sort by modification time, newest first'
