...
complete -c x86_64-linux-gnu-gold -o Bsymbolic -d 'Bind defined symbols locally'
complete -c x86_64-linux-gnu-gold -o Bsymbolic-functions -d 'Bind defined function symbols locally'
