...
alias ubuntu-access-token="cat /media/tarik/Data/creds/ubuntu-access-token|xclip -selection clipboard"
alias bitbucket-app-password="cat /media/tarik/Data/creds/bitbucket-app-password|xclip -selection clipboard"
alias masheen-staging-creds="cat /media/tarik/Data/creds/masheen-staging-creds|xclip -selection clipboard"
alias masheen-live-creds="cat /media/tarik/Data/creds/masheen-live-creds|xclip -selection clipboard"
